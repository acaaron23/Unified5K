...
export declare const usePaymentMethods: () => {
    data: import("@clerk/types").BillingPaymentSourceResource[];
    count: number;
    ...
    setData: (data?: import("@clerk/types").ClerkPaginatedResponse<import("@clerk/types").BillingPaymentSourceResource> | ((currentData?: import("@clerk/types").ClerkPaginatedResponse<import("@clerk/types").BillingPaymentSourceResource> | undefined) => import("@clerk/types").ClerkPaginatedResponse<import("@clerk/types").BillingPaymentSourceResource> | Promise<import("@clerk/types").ClerkPaginatedResponse<import("@clerk/types").BillingPaymentSourceResource> | undefined> | undefined) | undefined) => Promise<import("@clerk/types").ClerkPaginatedResponse<import("@clerk/types").BillingPaymentSourceResource> | undefined>;
};
