...
var frFR = {
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "\xCAtes-vous s\xFBr(e) de vouloir supprimer votre compte de Clerk ? Veuillez contacter le propri\xE9taire de l'application pour supprimer vos informations de leur application et d'autres services.",
      messageLine2: "Cette action est d\xE9finitive et irr\xE9versible.",
