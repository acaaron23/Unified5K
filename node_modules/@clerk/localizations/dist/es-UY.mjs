...
var esUY = {
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "\xBFEst\xE1s seguro de que quer\xE9s eliminar tu cuenta de Clerk? Por favor, contacta al propietario de la aplicaci\xF3n para eliminar tu informaci\xF3n de su aplicaci\xF3n y otros servicios.",
      messageLine2: "Esta acci\xF3n es permanente e irreversible.",
