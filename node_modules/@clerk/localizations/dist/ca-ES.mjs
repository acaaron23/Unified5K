...
var caES = {
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "Est\xE0s segur que vols eliminar el teu compte de Clerk? Si us plau, contacta amb el propietari de l'aplicaci\xF3 per eliminar la teva informaci\xF3 de la seva aplicaci\xF3 i altres serveis.",
      messageLine2: "Aquesta acci\xF3 \xE9s permanent i irreversible.",
