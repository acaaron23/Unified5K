...
var nlNL = {
  ...
  userProfile: {
    ...
    deletePage: {
      ...
      messageLine1: "Weet je zeker dat je je account van Clerk wilt verwijderen? Neem contact op met de eigenaar van de applicatie om je informatie uit hun applicatie en andere services te verwijderen.",
